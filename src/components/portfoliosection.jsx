      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                activeFilter === category
                  ...
                  : 'bg-black/5 dark:bg-white/[0.03] border border-black/10 dark:border-white/[0.08] text-gray-600 dark:text-white/50 hover:text-gray-900 dark:text-white hover:bg-black/5 dark:bg-white/[0.06]'
              }`}
            >
              {category}
            </button>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredProjects.map((project) => (
            <div key={project.id} className="glass group overflow-hidden">
              ...
              {/* Info */}
              <div className="p-8">
                <span className="inline-block px-3 py-1 rounded-full border border-black/10 dark:border-white/[0.08] bg-black/5 dark:bg-white/[0.03] text-xs font-medium text-gray-600 dark:text-white/40 mb-4">
                  {project.category}
                </span>

                <h3 className="text-2xl font-semibold text-gray-600 dark:text-white/90 tracking-tight mb-3 group-hover:text-gray-900 dark:text-white transition-colors duration-300">
                  {project.title}
                </h3>

                <p className="text-gray-600 dark:text-white/40 leading-relaxed font-light mb-6 group-hover:text-gray-600 dark:text-white/50 transition-colors duration-300">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="px-2.5 py-1 text-[10px] font-medium tracking-wide uppercase rounded-full border border-black/10 dark:border-white/[0.06] bg-black/5 dark:bg-white/[0.03] text-gray-600 dark:text-white/35"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-3">
                  {project.liveLink && (
                    <a
                      ...
                      className="group/btn flex-1 inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-gray-900 text-white dark:bg-white dark:text-black rounded-full font-medium text-sm hover:shadow-[0_0_30px_rgba(255,255,255,0.15)] hover:scale-[1.02] transition-all duration-500"
                    >
                  ...
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-6 py-3.5 rounded-full border border-black/10 dark:border-white/[0.1] text-gray-600 dark:text-white/60 font-medium text-sm hover:bg-black/5 dark:bg-white/[0.05] hover:text-gray-900 dark:text-white transition-all duration-300 flex items-center justify-center gap-2"
                    >
        ...
        {filteredProjects.length === 0 && (
          <div className="mt-16 text-center py-20">
            <svg className="w-16 h-16 mx-auto text-gray-600 dark:text-white/15" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="mt-4 text-xl font-medium text-gray-600 dark:text-white/60">
              No projects found
            </h3>
            <p className="mt-2 text-gray-600 dark:text-white/30 font-light">
        ...
        <div className="mt-32">
          <div className="glass p-12 relative overflow-hidden">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <span className="block text-5xl font-bold tracking-tighter text-gray-600 dark:text-white/90 mb-2">{projects.length}+</span>
                <span className="text-sm tracking-[0.15em] uppercase text-gray-600 dark:text-white/35 font-medium">Projects Completed</span>
              </div>
              <div>
                <span className="block text-5xl font-bold tracking-tighter text-gray-600 dark:text-white/90 mb-2">100%</span>
                <span className="text-sm tracking-[0.15em] uppercase text-gray-600 dark:text-white/35 font-medium">Client Satisfaction</span>
              </div>
              <div>
                <span className="block text-5xl font-bold tracking-tighter text-gray-600 dark:text-white/90 mb-2">2+</span>
                <span className="text-sm tracking-[0.15em] uppercase text-gray-600 dark:text-white/35 font-medium">Years Experience</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-32 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-white/40 max-w-2xl mx-auto font-light mb-10">
